...
franka_msgs__msg__Errors__are_equal(const franka_msgs__msg__Errors * lhs, const franka_msgs__msg__Errors * rhs)
{
  ...
  // joint_move_in_wrong_direction
  if (lhs->joint_move_in_wrong_direction != rhs->joint_move_in_wrong_direction) {
    return false;
  }
  // cartesian_spline_motion_generator_violation
  if (lhs->cartesian_spline_motion_generator_violation != rhs->cartesian_spline_motion_generator_violation) {
    return false;
  }
  // joint_via_motion_generator_planning_joint_limit_violation
  if (lhs->joint_via_motion_generator_planning_joint_limit_violation != rhs->joint_via_motion_generator_planning_joint_limit_violation) {
    return false;
  }
  // base_acceleration_initialization_timeout
  if (lhs->base_acceleration_initialization_timeout != rhs->base_acceleration_initialization_timeout) {
    return false;
  }
  // base_acceleration_invalid_reading
  if (lhs->base_acceleration_invalid_reading != rhs->base_acceleration_invalid_reading) {
    return false;
  }
  return true;
}
  ...
  franka_msgs__msg__Errors * output)
{
  ...
  // joint_move_in_wrong_direction
  output->joint_move_in_wrong_direction = input->joint_move_in_wrong_direction;
  // cartesian_spline_motion_generator_violation
  output->cartesian_spline_motion_generator_violation = input->cartesian_spline_motion_generator_violation;
  // joint_via_motion_generator_planning_joint_limit_violation
  output->joint_via_motion_generator_planning_joint_limit_violation = input->joint_via_motion_generator_planning_joint_limit_violation;
  // base_acceleration_initialization_timeout
  output->base_acceleration_initialization_timeout = input->base_acceleration_initialization_timeout;
  // base_acceleration_invalid_reading
  output->base_acceleration_invalid_reading = input->base_acceleration_invalid_reading;
  return true;
}
