...
class Init_Errors_base_acceleration_invalid_reading
{
public:
  explicit Init_Errors_base_acceleration_invalid_reading(::franka_msgs::msg::Errors & msg)
  : msg_(msg)
  {}
  ::franka_msgs::msg::Errors base_acceleration_invalid_reading(::franka_msgs::msg::Errors::_base_acceleration_invalid_reading_type arg)
  {
    msg_.base_acceleration_invalid_reading = std::move(arg);
...
class Init_Errors_base_acceleration_initialization_timeout
{
public:
  explicit Init_Errors_base_acceleration_initialization_timeout(::franka_msgs::msg::Errors & msg)
  : msg_(msg)
  {}
  Init_Errors_base_acceleration_invalid_reading base_acceleration_initialization_timeout(::franka_msgs::msg::Errors::_base_acceleration_initialization_timeout_type arg)
  {
    msg_.base_acceleration_initialization_timeout = std::move(arg);
    return Init_Errors_base_acceleration_invalid_reading(msg_);
  }
...
class Init_Errors_joint_via_motion_generator_planning_joint_limit_violation
{
public:
  explicit Init_Errors_joint_via_motion_generator_planning_joint_limit_violation(::franka_msgs::msg::Errors & msg)
  : msg_(msg)
  {}
  Init_Errors_base_acceleration_initialization_timeout joint_via_motion_generator_planning_joint_limit_violation(::franka_msgs::msg::Errors::_joint_via_motion_generator_planning_joint_limit_violation_type arg)
  {
    msg_.joint_via_motion_generator_planning_joint_limit_violation = std::move(arg);
    return Init_Errors_base_acceleration_initialization_timeout(msg_);
  }
...
class Init_Errors_cartesian_spline_motion_generator_violation
{
public:
  explicit Init_Errors_cartesian_spline_motion_generator_violation(::franka_msgs::msg::Errors & msg)
  : msg_(msg)
  {}
  Init_Errors_joint_via_motion_generator_planning_joint_limit_violation cartesian_spline_motion_generator_violation(::franka_msgs::msg::Errors::_cartesian_spline_motion_generator_violation_type arg)
  {
    msg_.cartesian_spline_motion_generator_violation = std::move(arg);
    return Init_Errors_joint_via_motion_generator_planning_joint_limit_violation(msg_);
  }
...
class Init_Errors_joint_move_in_wrong_direction
{
public:
  explicit Init_Errors_joint_move_in_wrong_direction(::franka_msgs::msg::Errors & msg)
  : msg_(msg)
  {}
  Init_Errors_cartesian_spline_motion_generator_violation joint_move_in_wrong_direction(::franka_msgs::msg::Errors::_joint_move_in_wrong_direction_type arg)
  {
    msg_.joint_move_in_wrong_direction = std::move(arg);
    return Init_Errors_cartesian_spline_motion_generator_violation(msg_);
  }
...
public:
  ...
  : msg_(msg)
  {}
  Init_Errors_joint_move_in_wrong_direction instability_detected(::franka_msgs::msg::Errors::_instability_detected_type arg)
  {
    msg_.instability_detected = std::move(arg);
    return Init_Errors_joint_move_in_wrong_direction(msg_);
  }
