  ...
  std::ostream & out)
{
  ...
  {
    out << "joint_move_in_wrong_direction: ";
    rosidl_generator_traits::value_to_yaml(msg.joint_move_in_wrong_direction, out);
    out << ", ";
  }

  // member: cartesian_spline_motion_generator_violation
  {
    out << "cartesian_spline_motion_generator_violation: ";
    rosidl_generator_traits::value_to_yaml(msg.cartesian_spline_motion_generator_violation, out);
    out << ", ";
  }

  // member: joint_via_motion_generator_planning_joint_limit_violation
  {
    out << "joint_via_motion_generator_planning_joint_limit_violation: ";
    rosidl_generator_traits::value_to_yaml(msg.joint_via_motion_generator_planning_joint_limit_violation, out);
    out << ", ";
  }

  // member: base_acceleration_initialization_timeout
  {
    out << "base_acceleration_initialization_timeout: ";
    rosidl_generator_traits::value_to_yaml(msg.base_acceleration_initialization_timeout, out);
    out << ", ";
  }

  // member: base_acceleration_invalid_reading
  {
    out << "base_acceleration_invalid_reading: ";
    rosidl_generator_traits::value_to_yaml(msg.base_acceleration_invalid_reading, out);
  }
  out << "}";
