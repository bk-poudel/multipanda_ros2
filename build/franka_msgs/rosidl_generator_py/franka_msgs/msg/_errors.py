...
class Errors(metaclass=Metaclass_Errors):
    ...
    __slots__ = [
        ...
        '_joint_move_in_wrong_direction',
        '_cartesian_spline_motion_generator_violation',
        '_joint_via_motion_generator_planning_joint_limit_violation',
        '_base_acceleration_initialization_timeout',
        '_base_acceleration_invalid_reading',
    ]
    ...
    _fields_and_field_types = {
        ...
        'joint_move_in_wrong_direction': 'boolean',
        'cartesian_spline_motion_generator_violation': 'boolean',
        'joint_via_motion_generator_planning_joint_limit_violation': 'boolean',
        'base_acceleration_initialization_timeout': 'boolean',
        'base_acceleration_invalid_reading': 'boolean',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.joint_move_in_wrong_direction = kwargs.get('joint_move_in_wrong_direction', bool())
        self.cartesian_spline_motion_generator_violation = kwargs.get('cartesian_spline_motion_generator_violation', bool())
        self.joint_via_motion_generator_planning_joint_limit_violation = kwargs.get('joint_via_motion_generator_planning_joint_limit_violation', bool())
        self.base_acceleration_initialization_timeout = kwargs.get('base_acceleration_initialization_timeout', bool())
        self.base_acceleration_invalid_reading = kwargs.get('base_acceleration_invalid_reading', bool())
    ...
    def __eq__(self, other):
        ...
        if self.instability_detected != other.instability_detected:
            return False
        if self.joint_move_in_wrong_direction != other.joint_move_in_wrong_direction:
            return False
        if self.cartesian_spline_motion_generator_violation != other.cartesian_spline_motion_generator_violation:
            return False
        if self.joint_via_motion_generator_planning_joint_limit_violation != other.joint_via_motion_generator_planning_joint_limit_violation:
            return False
        if self.base_acceleration_initialization_timeout != other.base_acceleration_initialization_timeout:
            return False
        if self.base_acceleration_invalid_reading != other.base_acceleration_invalid_reading:
            return False
        return True
    ...
    @builtins.property
    def joint_move_in_wrong_direction(self):
        """Message field 'joint_move_in_wrong_direction'."""
        return self._joint_move_in_wrong_direction

    @joint_move_in_wrong_direction.setter
    def joint_move_in_wrong_direction(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'joint_move_in_wrong_direction' field must be of type 'bool'"
        self._joint_move_in_wrong_direction = value

    @builtins.property
    def cartesian_spline_motion_generator_violation(self):
        """Message field 'cartesian_spline_motion_generator_violation'."""
        return self._cartesian_spline_motion_generator_violation

    @cartesian_spline_motion_generator_violation.setter
    def cartesian_spline_motion_generator_violation(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'cartesian_spline_motion_generator_violation' field must be of type 'bool'"
        self._cartesian_spline_motion_generator_violation = value

    @builtins.property
    def joint_via_motion_generator_planning_joint_limit_violation(self):
        """Message field 'joint_via_motion_generator_planning_joint_limit_violation'."""
        return self._joint_via_motion_generator_planning_joint_limit_violation

    @joint_via_motion_generator_planning_joint_limit_violation.setter
    def joint_via_motion_generator_planning_joint_limit_violation(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'joint_via_motion_generator_planning_joint_limit_violation' field must be of type 'bool'"
        self._joint_via_motion_generator_planning_joint_limit_violation = value

    @builtins.property
    def base_acceleration_initialization_timeout(self):
        """Message field 'base_acceleration_initialization_timeout'."""
        return self._base_acceleration_initialization_timeout

    @base_acceleration_initialization_timeout.setter
    def base_acceleration_initialization_timeout(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'base_acceleration_initialization_timeout' field must be of type 'bool'"
        self._base_acceleration_initialization_timeout = value

    @builtins.property
    def base_acceleration_invalid_reading(self):
        """Message field 'base_acceleration_invalid_reading'."""
        return self._base_acceleration_invalid_reading

    @base_acceleration_invalid_reading.setter
    def base_acceleration_invalid_reading(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'base_acceleration_invalid_reading' field must be of type 'bool'"
        self._base_acceleration_invalid_reading = value
