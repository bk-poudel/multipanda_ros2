  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: joint_move_in_wrong_direction
  {
    cdr << (ros_message->joint_move_in_wrong_direction ? true : false);
  }

  // Field name: cartesian_spline_motion_generator_violation
  {
    cdr << (ros_message->cartesian_spline_motion_generator_violation ? true : false);
  }

  // Field name: joint_via_motion_generator_planning_joint_limit_violation
  {
    cdr << (ros_message->joint_via_motion_generator_planning_joint_limit_violation ? true : false);
  }

  // Field name: base_acceleration_initialization_timeout
  {
    cdr << (ros_message->base_acceleration_initialization_timeout ? true : false);
  }

  // Field name: base_acceleration_invalid_reading
  {
    cdr << (ros_message->base_acceleration_invalid_reading ? true : false);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: joint_move_in_wrong_direction
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->joint_move_in_wrong_direction = tmp ? true : false;
  }
  ...
  // Field name: cartesian_spline_motion_generator_violation
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->cartesian_spline_motion_generator_violation = tmp ? true : false;
  }
  ...
  // Field name: joint_via_motion_generator_planning_joint_limit_violation
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->joint_via_motion_generator_planning_joint_limit_violation = tmp ? true : false;
  }
  ...
  // Field name: base_acceleration_initialization_timeout
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->base_acceleration_initialization_timeout = tmp ? true : false;
  }
  ...
  // Field name: base_acceleration_invalid_reading
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->base_acceleration_invalid_reading = tmp ? true : false;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name joint_move_in_wrong_direction
  {
    size_t item_size = sizeof(ros_message->joint_move_in_wrong_direction);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name cartesian_spline_motion_generator_violation
  {
    size_t item_size = sizeof(ros_message->cartesian_spline_motion_generator_violation);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name joint_via_motion_generator_planning_joint_limit_violation
  {
    size_t item_size = sizeof(ros_message->joint_via_motion_generator_planning_joint_limit_violation);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name base_acceleration_initialization_timeout
  {
    size_t item_size = sizeof(ros_message->base_acceleration_initialization_timeout);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name base_acceleration_invalid_reading
  {
    size_t item_size = sizeof(ros_message->base_acceleration_invalid_reading);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  // member: joint_move_in_wrong_direction
  {
    size_t array_size = 1;
  ...
  // member: cartesian_spline_motion_generator_violation
  {
    size_t array_size = 1;
  ...
  // member: joint_via_motion_generator_planning_joint_limit_violation
  {
    size_t array_size = 1;
  ...
  // member: base_acceleration_initialization_timeout
  {
    size_t array_size = 1;
  ...
  // member: base_acceleration_invalid_reading
  {
    size_t array_size = 1;
  ...
  if (is_plain) {
    ...
    is_plain =
      (
      offsetof(DataType, base_acceleration_invalid_reading) +
      last_member_size
      ) == ret_val;
  }
