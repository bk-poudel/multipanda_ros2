  ...
  void * untyped_ros_message)
{
  ...
  _SetMujocoPoses_Request__ros_msg_type * ros_message = static_cast<_SetMujocoPoses_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: objects
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  void * untyped_ros_message)
{
  ...
  _SetMujocoPoses_Response__ros_msg_type * ros_message = static_cast<_SetMujocoPoses_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: valid
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
