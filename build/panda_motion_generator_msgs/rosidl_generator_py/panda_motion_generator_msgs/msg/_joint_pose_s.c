...
bool panda_motion_generator_msgs__msg__joint_pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("panda_motion_generator_msgs.msg._joint_pose.JointPose", full_classname_dest, 53) == 0);
  }
  panda_motion_generator_msgs__msg__JointPose * ros_message = _ros_message;
  {  // q
...
{
  /* NOTE(esteve): Call constructor of JointPose */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("panda_motion_generator_msgs.msg._joint_pose");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "JointPose");
