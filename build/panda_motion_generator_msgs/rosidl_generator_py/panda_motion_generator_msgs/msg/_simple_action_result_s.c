...
bool panda_motion_generator_msgs__msg__simple_action_result__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("panda_motion_generator_msgs.msg._simple_action_result.SimpleActionResult", full_classname_dest, 72) == 0);
  }
  panda_motion_generator_msgs__msg__SimpleActionResult * ros_message = _ros_message;
  {  // state
...
{
  /* NOTE(esteve): Call constructor of SimpleActionResult */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("panda_motion_generator_msgs.msg._simple_action_result");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SimpleActionResult");
