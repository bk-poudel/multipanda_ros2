...
#include "panda_motion_generator_msgs/msg/detail/joint_pose__rosidl_typesupport_fastrtps_c.h"
...
using _JointPose__ros_msg_type = panda_motion_generator_msgs__msg__JointPose;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _JointPose__ros_msg_type * ros_message = static_cast<const _JointPose__ros_msg_type *>(untyped_ros_message);
  // Field name: q
  {
  ...
  void * untyped_ros_message)
{
  ...
  _JointPose__ros_msg_type * ros_message = static_cast<_JointPose__ros_msg_type *>(untyped_ros_message);
  // Field name: q
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
...
static uint32_t _JointPose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_panda_motion_generator_msgs__msg__JointPose(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = panda_motion_generator_msgs__msg__JointPose;
    is_plain =
      (
      offsetof(DataType, q) +
      last_member_size
...
static size_t _JointPose__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_panda_motion_generator_msgs__msg__JointPose(
...
static message_type_support_callbacks_t __callbacks_JointPose = {
...
static rosidl_message_type_support_t _JointPose__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_JointPose,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, panda_motion_generator_msgs, msg, JointPose)() {
  return &_JointPose__type_support;
}
