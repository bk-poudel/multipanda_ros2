...
struct Errors_
{
  ...
  using _joint_move_in_wrong_direction_type =
    bool;
  _joint_move_in_wrong_direction_type joint_move_in_wrong_direction;
  using _cartesian_spline_motion_generator_violation_type =
    bool;
  _cartesian_spline_motion_generator_violation_type cartesian_spline_motion_generator_violation;
  using _joint_via_motion_generator_planning_joint_limit_violation_type =
    bool;
  ...
  using _base_acceleration_initialization_timeout_type =
    bool;
  _base_acceleration_initialization_timeout_type base_acceleration_initialization_timeout;
  using _base_acceleration_invalid_reading_type =
    bool;
  ...
  Type & set__joint_move_in_wrong_direction(
    const bool & _arg)
  {
    this->joint_move_in_wrong_direction = _arg;
    return *this;
  }
  Type & set__cartesian_spline_motion_generator_violation(
    const bool & _arg)
  {
    this->cartesian_spline_motion_generator_violation = _arg;
    return *this;
  }
  Type & set__joint_via_motion_generator_planning_joint_limit_violation(
    const bool & _arg)
  {
    this->joint_via_motion_generator_planning_joint_limit_violation = _arg;
    return *this;
  }
  Type & set__base_acceleration_initialization_timeout(
    const bool & _arg)
  {
    this->base_acceleration_initialization_timeout = _arg;
    return *this;
  }
  Type & set__base_acceleration_invalid_reading(
    const bool & _arg)
  {
    this->base_acceleration_invalid_reading = _arg;
    return *this;
  }
  ...
  bool operator==(const Errors_ & other) const
  {
    ...
    if (this->joint_move_in_wrong_direction != other.joint_move_in_wrong_direction) {
      return false;
    }
    if (this->cartesian_spline_motion_generator_violation != other.cartesian_spline_motion_generator_violation) {
      return false;
    }
    if (this->joint_via_motion_generator_planning_joint_limit_violation != other.joint_via_motion_generator_planning_joint_limit_violation) {
      return false;
    }
    if (this->base_acceleration_initialization_timeout != other.base_acceleration_initialization_timeout) {
      return false;
    }
    if (this->base_acceleration_invalid_reading != other.base_acceleration_invalid_reading) {
      return false;
    }
    return true;
  }
