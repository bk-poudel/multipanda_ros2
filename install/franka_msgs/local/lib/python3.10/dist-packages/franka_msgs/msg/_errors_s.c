...
bool franka_msgs__msg__errors__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // joint_move_in_wrong_direction
    PyObject * field = PyObject_GetAttrString(_pymsg, "joint_move_in_wrong_direction");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->joint_move_in_wrong_direction = (Py_True == field);
    Py_DECREF(field);
  }
  {  // cartesian_spline_motion_generator_violation
    PyObject * field = PyObject_GetAttrString(_pymsg, "cartesian_spline_motion_generator_violation");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->cartesian_spline_motion_generator_violation = (Py_True == field);
    Py_DECREF(field);
  }
  {  // joint_via_motion_generator_planning_joint_limit_violation
    PyObject * field = PyObject_GetAttrString(_pymsg, "joint_via_motion_generator_planning_joint_limit_violation");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->joint_via_motion_generator_planning_joint_limit_violation = (Py_True == field);
    Py_DECREF(field);
  }
  {  // base_acceleration_initialization_timeout
    PyObject * field = PyObject_GetAttrString(_pymsg, "base_acceleration_initialization_timeout");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->base_acceleration_initialization_timeout = (Py_True == field);
    Py_DECREF(field);
  }
  {  // base_acceleration_invalid_reading
    PyObject * field = PyObject_GetAttrString(_pymsg, "base_acceleration_invalid_reading");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->base_acceleration_invalid_reading = (Py_True == field);
    Py_DECREF(field);
  }
...
PyObject * franka_msgs__msg__errors__convert_to_py(void * raw_ros_message)
{
  ...
  {  // joint_move_in_wrong_direction
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->joint_move_in_wrong_direction ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "joint_move_in_wrong_direction", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // cartesian_spline_motion_generator_violation
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->cartesian_spline_motion_generator_violation ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "cartesian_spline_motion_generator_violation", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // joint_via_motion_generator_planning_joint_limit_violation
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->joint_via_motion_generator_planning_joint_limit_violation ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "joint_via_motion_generator_planning_joint_limit_violation", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // base_acceleration_initialization_timeout
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->base_acceleration_initialization_timeout ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "base_acceleration_initialization_timeout", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // base_acceleration_invalid_reading
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->base_acceleration_invalid_reading ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "base_acceleration_invalid_reading", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
